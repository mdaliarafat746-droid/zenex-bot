        ...
        try:
            ...
            if len(assigned_numbers) > 0:
                ...
                for num in assigned_numbers:
                    ...
                    # টেলিগ্রামের শেয়ার লিংক ফরম্যাট ব্যবহার করা হয়েছে, যা ট্যাপ করলে খুব সহজে কপি বা শেয়ার করা যায়
                    share_url = f"https://t.me/share/url?url=+{clean_num}"
                    keyboard.append([InlineKeyboardButton(btn_label, url=share_url)])
                ...
                result_msg = (
                    ...
                    f"🎟️ **Waiting for OTP**\n\n"
                    f"_নিচের নম্বরের বাটনে ক্লিক করলেই কপি করার অপশন পাবেন:_"
                )
